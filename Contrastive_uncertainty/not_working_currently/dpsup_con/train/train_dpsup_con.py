...
from Contrastive_uncertainty.dpsup_con.models.dpsup_con_module import DPSupConModule
from Contrastive_uncertainty.dpsup_con.run.dpsup_con_run_setup import run_name, Datamodule_selection,Channel_selection,callback_dictionary
...
def train(params):
    ...
    '''
    desired_callbacks = []
    model = DPSupConModule(emb_dim = config['emb_dim'],
        optimizer = config['optimizer'],learning_rate = config['learning_rate'],
        momentum = config['momentum'], weight_decay = config['weight_decay'],
        use_mlp = config['use_mlp'],distance_threshold=config['distance_threshold'],
