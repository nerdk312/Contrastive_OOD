...
class ODCMemory(nn.Module):
    ...
    def __init__(self, length, feat_dim, momentum, num_classes, min_cluster,
        ...
        # Feature dimensionality, momentum and number classes
    ...
    def init_memory(self, feature, label):
        ...
        if self.rank == 0:
            ...
            # Copy features into feature bank
    ...
    def _compute_centroids(self):
        ...
        return centroids
    # Gather indices and features from multiple GPUs
    ...
    # Update memory and feature bank
    def update_samples_memory(self, ind, feature):
        ...
        # compute new labels
        # Compute the similarity of a feature to the centroid to obtain new labels
        ...
        # Ratio of how much labels are changing
