...
class NCA_Module:
  ...
  def loss(self, X, y_mask):
    ...
    # Nawid- Pairwise distance of each data point from another datapoint
    ...
    # Nawid -  I believe this copies zeros to the diagonal 
  ...
  def train(
    ...
    for epoch in range(self.max_iters):
      ...
      for i in range(iters_per_epoch):
        ...
        # compute pairwise boolean class matrix - Nawid - Makes a N by N symmetric matrix where the entries which have ijth entry as True if datapoint i and j have the same label 
