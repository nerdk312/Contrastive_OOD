...
def callback_dictionary(Datamodule,config,data_dict):
    ...
    for ood_dataset in config['OOD_dataset']:
        ...
        OOD_callback = {                
                ...
                f'Hierarchical Subclusters {ood_dataset}' : Hierarchical_Subclusters_OOD(Datamodule, OOD_Datamodule,quick_callback=quick_callback, vector_level='fine',label_level='fine',num_clusters=10)}
