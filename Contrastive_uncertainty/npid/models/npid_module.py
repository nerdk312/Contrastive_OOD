...
from Contrastive_uncertainty.npid.models.simple_memory import SimpleMemory
from Contrastive_uncertainty.npid.utils.pl_metrics import precision_at_k

# Based on code from https://github.com/open-mmlab/OpenSelfSup/blob/master/openselfsup/models/npid.py
