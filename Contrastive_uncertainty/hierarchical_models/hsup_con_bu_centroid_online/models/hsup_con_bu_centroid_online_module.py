...
from Contrastive_uncertainty.hierarchical_models.hsup_con_bu_centroid_online.models.resnet_models import custom_resnet18,custom_resnet34,custom_resnet50

class HSupConBUCentroidOnlineModule(pl.LightningModule):
    def __init__(self,
        emb_dim: int = 128,
    ...
    def calculate_centroid_online(self, x, labels,no_classes): # Assume y is one hot encoder 
