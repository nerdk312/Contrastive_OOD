...
from Contrastive_uncertainty.general_hierarchy.datamodules.dataset_normalizations import cifar10_normalization
from Contrastive_uncertainty.general_hierarchy.datamodules.datamodule_transforms import CIFAR10_coarse_labels, dataset_with_indices, dataset_with_indices_hierarchy
...
class CIFAR10DataModule(LightningDataModule):
    ...
    def __init__(
        ...
        """
        .. figure:: https://3qeqpr26caki16dnhd19sv6by6v-wpengine.netdna-ssl
            Plot-of-a-Subset-of-Images-from-the-CIFAR
            :width: 400
            :alt: CIFAR-10
        Specs:
            - 10 classes (1 per class)
            - Each image is (3 x 32 x 32
        Standard CIFAR10, train, val, test splits
        Transforms::
            mnist_transforms = transform_lib.Compose([
                transform_lib.ToTensor(),
                transforms.Normalize(
                    mean=[x / 255.0 for x in
                    std=[x / 255.0 for x in
                )
            ])
        Example::
        ...
        Args:
            ...
            val_split: how many of the training images to
            num_workers: how many workers to use for loading
