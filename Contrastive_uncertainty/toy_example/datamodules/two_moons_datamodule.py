...
class TwoMoonsDataModule(LightningDataModule): # Data module for Two Moons dataset
    ...
    def train_dataloader(self):
        ...
        train_dataset = CustomTensorDataset((torch.from_numpy(self.X_train).float(), torch.from_numpy(self.y_train)),transform = self.train_transforms)
    ...
    def val_dataloader(self):
        ...
        val_dataset = CustomTensorDataset((torch.from_numpy(self.X_val).float(),torch.from_numpy(self.y_val)), transform = self.test_transforms)
    ...
    def test_dataloader(self):
        ...
        test_dataset = CustomTensorDataset((torch.from_numpy(self.X_test).float(), torch.from_numpy(self.y_test)), transform = self.test_transforms)
