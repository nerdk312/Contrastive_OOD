...
def callback_dictionary(Datamodule,OOD_Datamodule,config):
    ...
    inference_clusters = config['num_inference_clusters']
    ...
    callback_dict = {'Model_saving':ModelSaving(config['model_saving']), 
                'Metrics': MetricLogger(evaluation_metrics,num_classes,val_test_loader,evaltypes,quick_callback=quick_callback),
