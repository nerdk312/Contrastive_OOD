...
from Contrastive_uncertainty.Contrastive.models.resnet_models import custom_resnet18,custom_resnet34,custom_resnet50
from Contrastive_uncertainty.Contrastive.models.loss_functions import moco_loss, supervised_contrastive_loss
...
class ContrastiveModule(pl.LightningModule):
    ...
    def init_encoders(self):
        ...
        if self.hparams.instance_encoder == 'resnet18':
            ...
            encoder_q = resnet50(latent_size = self.hparams.emb_dim,num_channels = self.hparams.num_channels,num_classes = 10)
            encoder_k = resnet50(latent_size = self.hparams.emb_dim,num_channels = self.hparams.num_channels,num_classes = 10)
