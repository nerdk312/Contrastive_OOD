...
from Contrastive_uncertainty.toy_replica.toy_experiments.config.batch.batch_trainer_params import batch_trainer_hparams
...
for group_key, group_trainer_hparams in batch_trainer_hparams.items():
    ...
    runs = api.runs(path="nerdk312/Toy_evaluation", filters={"config.group":f'{group_key}'})
