...
from Contrastive_uncertainty.toy_replica.hierarchical_models.hsup_con_td_centroid.config.hsup_con_td_centroid_trainer_params import trainer_hparams
...
for run_path in run_paths:
    ...
    resume(run_path, trainer_hparams, HSupConTDCentroidToy, ModelInstance)