...
from Contrastive_uncertainty.toy_replica.hierarchical_models.hsup_con_bu_centroid_online.config.hsup_con_bu_centroid_online_trainer_params import trainer_hparams
...
for run_path in run_paths:
    ...
    resume(run_path, trainer_hparams, HSupConBUCentroidOnlineToy, ModelInstance)