...
class HPCLModule(pl.LightningModule):
    def __init__(self,
        datamodule,
        optimizer:str = 'sgd',
    ...
    def init_encoders(self):
        ...
        if self.hparams.instance_encoder == 'resnet18':
            ...
            encoder_q = custom_resnet18(latent_size = self.hparams.emb_dim,num_channels = self.hparams.datamodule.num_channels,num_classes = self.hparams.datamodule.num_classes)
            encoder_k = custom_resnet18(latent_size = self.hparams.emb_dim,num_channels = self.hparams.datamodule.num_channels,num_classes = self.hparams.datamodule.num_classes)
        elif self.hparams.instance_encoder =='resnet50':
            print('using resnet50')
            encoder_q = custom_resnet50(latent_size = self.hparams.emb_dim,num_channels = self.hparams.datamodule.num_channels,num_classes = self.hparams.datamodule.num_classes)
            encoder_k = custom_resnet50(latent_size = self.hparams.emb_dim,num_channels = self.hparams.datamodule.num_channels,num_classes = self.hparams.datamodule.num_classes)
