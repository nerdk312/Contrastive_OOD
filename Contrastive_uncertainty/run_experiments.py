...
from Contrastive_uncertainty.unsup_con_memory.train.train_unsup_con_memory import train as UnSupCon_training
'''
base_dict = dict(
...
model_dict = {'CE':{'params':cross_entropy_hparams,'train':CE_training},                
                ...
                'SupCon':{'params':sup_con_hparams,'train_transform':SupCon_training},
                'PCL':{'params':pcl_hparams,'train':PCL_training},                
                'UnSupConMemory':{'params':unsup_con_memory_hparams,'train':UnSupCon_training}
                }
...
# Go through a single model on all different datasets
    ...
    params['OOD_dataset'] = 'MNIST'
    train_method(params)

    params['dataset'] = 'MNIST'
    params['OOD_dataset'] = 'FashionMNIST'
    train_method(params)

    params['dataset'] = 'KMNIST'
    params['OOD_dataset'] = 'MNIST'
    train_method(params)

    params['dataset'] = 'CIFAR10'
    params['OOD_dataset'] = 'SVHN'
    train_method(params)
