...
from Contrastive_uncertainty.unsup_con_memory.run.unsup_con_memory_run_setup import run_name, Datamodule_selection,Channel_selection,callback_dictionary
