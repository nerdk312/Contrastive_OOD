...
from datamodules.dataset_normalizations import fashionmnist_normalization
...
class MNISTDataModule(LightningDataModule):
    ...
    def setup(self):
        ...
        dataset = self.DATASET(self.data_dir, train=True, download=True, transform=train_transforms, **self.extra_args)
