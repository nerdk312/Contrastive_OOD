...
from datamodules.svhn_datamodule import SVHNDataModule
from datamodules.datamodule_transforms import Moco2TrainCIFAR10Transforms, Moco2EvalCIFAR10Transforms,\
